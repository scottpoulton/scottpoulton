...
> $\displaystyle \text{ATP}_{(s)} + \text{Nicotine}_{(aq)} \rightarrow \text{Gemini Prompts}_{(g)}$
...
![Bear](https://img.shields.io/badge/Bear-black?style=for-the-badge&logo=bear&logoColor=white)
